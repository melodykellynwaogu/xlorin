document.addEventListener('DOMContentLoaded', function() {
    ...
    function doSearch() {
        ...
        resultDiv.innerHTML = "<div style='text-align:center;padding:24px;'><svg style='width:40px;height:40px;' viewBox='0 0 50 50'><circle cx='25' cy='25' r='20' fill='none' stroke='#4285f4' stroke-width='4' stroke-linecap='round' stroke-dasharray='31.415, 31.415' transform='rotate(0.00037 25 25)'><animateTransform attributeName='transform' type='rotate' from='0 25 25' to='360 25 25' dur='0.8s' repeatCount='indefinite'/></circle></svg></div>";
